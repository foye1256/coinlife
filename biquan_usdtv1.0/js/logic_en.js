                            ...
                            for(var i in res_array){
                                ...
                                for(var j in res_array[i]){
                                    if(100 == res_array[i].length){
                                        zh_arr.push(`<div class="swiper-slide" style="color:#BCA880" >${Number(j)+1}.${res_array[i][j].e_event}</div>`)
                                    }else{
                                        zh_arr.push(`<div class="swiper-slide" style="color:#939292" >${Number(j)+1}.${res_array[i][j].e_event}</div>`)
                                    }
                                }
                            }
                            for(let i in zh_arr){
